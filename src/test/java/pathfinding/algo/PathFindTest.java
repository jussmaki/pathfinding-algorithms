...
public class PathFindTest {
    ...
    public void getNeighbourCellsWorks1() {
        int[][] arr = {{1, 1},
                      {1, 1}};
        PathFind p = new PathFind();
        
        ArrayList<Point> neighbours1 = PSUtil.convertPSToArrayList(p.getNeighbourCells(arr, 0,0));
        ...
        ArrayList<Point> neighbours2 = PSUtil.convertPSToArrayList(p.getNeighbourCells(arr, 0,1));
        ...
        ArrayList<Point> neighbours3 = PSUtil.convertPSToArrayList(p.getNeighbourCells(arr, 1,0));
        ...
        ArrayList<Point> neighbours4 = PSUtil.convertPSToArrayList(p.getNeighbourCells(arr, 1,1));
    ...
    public void getNeighbourCellsworks2() {
        int[][] arr = {{0, 0},
                      {0, 0}};
        PathFind p = new PathFind();
        assertEquals(0, p.getNeighbourCells(arr, 0, 0).size());
        assertEquals(0, p.getNeighbourCells(arr, 0, 1).size());
        assertEquals(0, p.getNeighbourCells(arr, 1, 1).size());
        assertEquals(0, p.getNeighbourCells(arr, 1, 0).size());  
    }
}
