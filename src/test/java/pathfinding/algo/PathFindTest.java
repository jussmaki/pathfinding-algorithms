...
public class PathFindTest {
    ...
    public void getNeighbourCellsWorks1() {
        ...
        ArrayList<Point> neighbours1 = PSUtil.convertPSToArrayList(PathFind.getNeighbourCells(arr, 0, 0));
        ...
        ArrayList<Point> neighbours2 = PSUtil.convertPSToArrayList(PathFind.getNeighbourCells(arr, 0, 1));
        ...
        ArrayList<Point> neighbours3 = PSUtil.convertPSToArrayList(PathFind.getNeighbourCells(arr, 1, 0));
        ...
        ArrayList<Point> neighbours4 = PSUtil.convertPSToArrayList(PathFind.getNeighbourCells(arr, 1, 1));
