...
public class AStarTest {
    ...
    public void findsNotRouteWhenThereIsNoRoute() {
        int[][] arr = {{1, 1, 1},
                       {0, 0, 0},
                       {1, 1, 1}};
        ArrayList<Point> path = PSUtil.convertSQToArrayList(AStar.search(arr, 0, 0, 2, 2).getPath());
    ...
    public void findsRouteWhenThereIsOne2() {
        int[][] arr = {{1, 1, 0, 1, 1},
                       ...
                       {1, 1, 0, 0, 1},
                       {1, 1, 1, 1, 1}};
        ArrayList<Point> path = PSUtil.convertSQToArrayList(AStar.search(arr, 0, 1, 4, 3).getPath());
        assertTrue(path.size() > 0);
    }    
